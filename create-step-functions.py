...
job_name = 'glue-customer-churn-etl-io'
function_name = 'arn:aws:lambda:eu-west-1:' + account_id + ':function:query-training-status-io'
workflow_name = 'MyInferenceRoutine_io'
...
training_job_name = "CustomerChurnTrainingJob-io" + dateAsString
